			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<a href="#"><img src="https://download.logo.wine/logo/BKash/BKash-bKash-Logo.wine.png" class="img-fluid" width="100px" alt="" srcset=""></a>
								<a href="#"><img src="https://download.logo.wine/logo/Nagad/Nagad-Logo.wine.png" class="img-fluid" width="100px" alt="" srcset=""></a>
